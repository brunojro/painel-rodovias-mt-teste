...
var style_ACIDENTES_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        function rules_ACIDENTES_2(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_ACIDENTES_2rule0_eval_expression(context)) {
        ...
        var style = rules_ACIDENTES_2(feature, value);
        ;
